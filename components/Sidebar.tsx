  ...
  return (
    <aside className="w-60 h-full bg-gray-900 text-white flex flex-col overflow-y-auto">
      <div className="px-5 py-5 border-b border-gray-700">
        ...
        <p className="text-xs text-gray-400 dark:text-gray-400 mt-0.5 truncate">{name}</p>
      ...
      <nav className="flex-1 py-4 px-3 space-y-1">
        ...
        {isAdmin && (
          <div className="mt-6 pt-4 border-t border-gray-700">
            <p className="px-3 mb-2 text-[10px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-300 flex items-center gap-1.5">
