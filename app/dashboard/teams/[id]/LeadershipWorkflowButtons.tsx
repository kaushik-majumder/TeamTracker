    ...
    <>
      <div className="relative">
        <button
          ...
          className="p-1 text-gray-400 hover:text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800 rounded transition-colors"
          title="Workflow actions"
        >
          <MoreVertical size={16} />
        </button>
        {menu && (
          <div className="absolute right-0 top-full mt-1 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg shadow-lg z-10 min-w-[180px]">
            <button
              onMouseDown={() => { setModal('promotion'); setMenu(false) }}
              className="w-full flex items-center gap-2 px-3 py-2 text-sm text-left text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-800/50"
            >
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 w-full max-w-md shadow-xl">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100">Recommend Promotion · {subjectName}</h3>
              <button onClick={() => setModal(null)}><X size={18} className="text-gray-400 dark:text-gray-400" /></button>
            </div>
            ...
            {showSuccess && ps && 'success' in ps ? (
              <div className="flex flex-col items-center py-8 text-center">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-300 mt-1">Sent to higher leadership for review.</p>
              </div>
            ) : (
              <form action={promoAction} className="space-y-3">
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-600 dark:text-gray-300 mb-1">Current Title</label>
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-600 dark:text-gray-300 mb-1">Proposed Title</label>
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-600 dark:text-gray-300 mb-1">Justification</label>
      ...
      {modal === 'salary' && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 w-full max-w-md shadow-xl">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100">Recommend Salary Hike · {subjectName}</h3>
              <button onClick={() => setModal(null)}><X size={18} className="text-gray-400 dark:text-gray-400" /></button>
            </div>
            ...
            {showSuccess && ss && 'success' in ss ? (
              ...
              <form action={salaryAction} className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs font-medium text-gray-600 dark:text-gray-300 mb-1">Current Salary ($)</label>
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-600 dark:text-gray-300 mb-1">Proposed Salary ($)</label>
