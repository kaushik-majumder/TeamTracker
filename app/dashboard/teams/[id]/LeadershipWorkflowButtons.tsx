    ...
    <>
      <div className="relative">
        <button
          ...
          className="p-1 text-gray-400 hover:text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:bg-gray-800 rounded transition-colors"
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 w-full max-w-md shadow-xl">
            ...
            {showSuccess && ps && 'success' in ps ? (
              <div className="flex flex-col items-center py-8 text-center">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Sent to higher leadership for review.</p>
              </div>
            ) : (
