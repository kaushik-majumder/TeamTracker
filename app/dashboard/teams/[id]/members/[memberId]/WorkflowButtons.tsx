    ...
    <>
      <div className="flex gap-2">
        <button
          ...
          className="flex items-center gap-1.5 text-sm bg-white dark:bg-gray-900 border border-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-800/50 text-gray-700 dark:text-gray-200 font-medium px-3 py-2 rounded-lg transition-colors"
        >
          <TrendingUp size={14} />
          Recommend Promotion
        </button>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 w-full max-w-md shadow-xl">
            ...
            {showSuccess && ps && 'success' in ps ? (
              <div className="flex flex-col items-center py-8 text-center">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-300 mt-1">Sent to the team&apos;s manager for review.</p>
              </div>
            ) : (
