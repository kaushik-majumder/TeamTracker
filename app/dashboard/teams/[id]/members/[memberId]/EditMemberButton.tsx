        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 w-full max-w-md shadow-xl">
            ...
            <form action={action} className="space-y-3">
              ...
              <div>
                <label className="block text-xs font-medium text-gray-600 dark:text-gray-300 mb-1">Join Date</label>
              ...
              <div className="flex gap-2 pt-1">
                <button type="button" onClick={() => setOpen(false)} className="flex-1 text-sm border border-gray-300 text-gray-600 dark:text-gray-300 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-800/50 transition-colors">
                  Cancel
                </button>
