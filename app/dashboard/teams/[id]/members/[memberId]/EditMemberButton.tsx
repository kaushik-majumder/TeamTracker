          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-xl">
            ...
            <form action={action} className="space-y-3">
              ...
              <div className="flex gap-2 pt-1">
                <button type="button" onClick={() => setOpen(false)} className="flex-1 text-sm border border-gray-300 text-gray-600 py-2 rounded-lg hover:bg-gray-50 transition-colors">
                  Cancel
                </button>
