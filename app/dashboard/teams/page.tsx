          ...
          {teams.map((team) => {
            ...
            return (
              <Link
                ...
                className={`group relative bg-white rounded-xl border ${c.border} p-5 overflow-hidden transition-all hover:shadow-lg ${c.hoverShadow} hover:-translate-y-0.5 block`}
              >
                ...
                <div className="pl-2">
                  ...
                  {lead && (
                    <p className="text-xs text-gray-500 mt-4">
                      Lead: <span className="font-medium text-gray-700">{lead.user.name}</span>
                    </p>
                  )}
                </div>
              </Link>
