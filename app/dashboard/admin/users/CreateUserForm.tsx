          ...
          {isManager ? (
            <>
              <label className="block text-xs font-medium text-gray-600 dark:text-gray-300 mb-2">
                Assign to Teams <span className="text-gray-400 dark:text-gray-400 font-normal">(pick any number)</span>
              </label>

              {teams.length === 0 ? (
                <p className="text-xs text-gray-500 dark:text-gray-300 mb-2">No teams exist yet — create one below.</p>
              ) : (
              ...
              <label className="flex items-center gap-2 text-sm cursor-pointer mb-2">
                <input
                  ...
                  className="text-blue-600 focus:ring-blue-500"
                />
                <span className="text-gray-700 dark:text-gray-200">Also create a new team</span>
              </label>
              ...
              {selectedTeamIds.length === 0 && !addNewTeam && (
                <p className="text-[11px] text-gray-400 dark:text-gray-400 mt-2">
