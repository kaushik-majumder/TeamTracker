    ...
    <div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-3">
          {teams.length === 0 ? (
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6 text-center text-sm text-gray-400 dark:text-gray-400">
                ...
                <Link key={team.id} href={`/dashboard/admin/teams/${team.id}`} className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4 block hover:shadow-sm transition-shadow">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-x-4 gap-y-1 mt-3 text-xs text-gray-500 dark:text-gray-300">
