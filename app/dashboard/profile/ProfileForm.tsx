    ...
    <form action={action} className="space-y-5">
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-gray-500 mb-3">PNG, JPG, or WebP. Resized to 256×256 automatically.</p>

          <div className="flex flex-wrap gap-2">
            <label className="inline-flex items-center gap-1.5 text-sm bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium px-3 py-1.5 rounded-lg transition-colors cursor-pointer">
              <Upload size={14} />
